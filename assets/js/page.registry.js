window.PAGE_REGISTRY = {
  ...
  pages: {
    home: {
      ...
      mode: "inline",
      description:
        "좌측 메뉴는 실제 시스템 메뉴 순서와 동일하게 유지되며, 자주 찾는 가이드는 아래 카드에서 바로 진입할 수 있습니다.",
      html: `
        <div class="guide-section">
          ...
          <div class="guide-note">
            자주 사용하는 항목은 아래 카드에서 바로 이동하고,
            그 외 메뉴는 좌측 사이드바에서 실제 시스템과 동일한 순서로 탐색하면 됩니다.
          </div>
        </div>
        ...
        <div class="guide-section">
          ...
          <div class="guide-card-grid">
            ...
            <a href="#" class="guide-card" data-page="sku">
              ...
              <p class="guide-card-summary">SKU 관련 기본 가이드 예시 페이지입니다.</p>
            </a>
            ...
            <a href="#" class="guide-card" data-page="order-processing">
              ...
              <p class="guide-card-summary">현재는 자리 페이지로 열리며, 나중에 상세 문서로 교체할 수 있습니다.</p>
            </a>
          </div>
        </div>
